	...
	<head>
		...
		<title>Print Cashbank Report</title>
	</head>
		...
		<div>
			<div style="margin: 0 auto; width: 500px;">
				<table style="table-layout:fixed;">
					...
					<tr>
						<td colspan="2" style="text-align: center;"><strong>CASH BANK AS AT {{ date_format($date_from, 'jS F Y') }} TO {{ date_format($date_to, 'jS F Y') }}</strong></td>
					</tr>
				</table>
