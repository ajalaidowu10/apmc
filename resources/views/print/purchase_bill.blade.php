	...
	<head>
		...
		<title>Print Purchase Bill</title>
	</head>
	<body>
			...
			<table class="table table-bordered" cellspacing="0">
			  <tbody>
			    <tr>
			      <td>
			        <p>
			          <strong>Invoice#:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $data['get_report'][0]->inv_no }}
			        </p>
			        <p>
			         <strong>Invoice Date:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ date_format($data['date'], 'jS F Y') }}</p> 
			      </td>
			...
			<table class="table table-bordered" cellspacing="0" style="margin-top: -20px;">
			  <thead>
			    <tr style="text-align: left; background-color: #f8f9fa;">
			      <th>BILL TO: {{ $data['get_report'][0]->acct_name }} | {{ $data['get_report'][0]->area }}</th>
			    </tr>
			  </thead>
			</table> 
			<table class="table  table-bordered" cellspacing="0" style="margin-top: -20px;"> 
			 <thead> 
			  ...
			  <tbody>
			  	...
			  	@endphp
			    @foreach ($data['get_report'] as $bill)
			    	@php
			    ...
			    <tr>
			      ...
			      <td style="text-align: right;">{{ number_format(round($data['prev_bal']), 2) }}</td>
			    </tr>
			    @php
			    	$total = $data['prev_bal'] + $total_final_amount;
			    	$amount_paid_today = $data['cur_bal'];
