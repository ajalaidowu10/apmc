          ...
          <table class="table table-bordered" cellspacing="0">
            ...
            <tbody>
              <tr v-if="totalRoom">
                ...
                <td>
                  <strong>
                   &#8377 {{ totalRoomAmount }}
                  </strong>
                </td>
              </tr>
              <tr v-if="totalExtraBed">
                <td>
                  {{ totalExtraBed }} Extra Beds
                </td>
                <td>
                 <strong>
                  &#8377 {{ totalBedAmount}}
              ...
              <tr>
                <td colspan="2">
                 ...
                 Make sure you read our<v-btn text small to="/terms-and-conditions" color="primary" target="_blank">terms and conditions</v-btn>
                </td>
              </tr>
              <tr>
                <td>
              ...
              <tr class="text-center">
                <td colspan="2" class="text-center">
                  <v-btn tile small  color="primary">PAY TO BANK</v-btn>
                </td>
              </tr>
              <tr>
                <td>BANK: </td>
                <td>RED STONE RESORT HDFC BANK</td>
              </tr>
              <tr>
                <td>ACC NO: </td>
                <td>50200052804126</td>
              </tr>
              <tr>
              ...
              <tr class="text-center">
                <td colspan="2" class="text-center">
                  <v-btn tile x-large color="success" @click="finishBooking">FINISH</v-btn>
                </td>
              </tr>
            </tbody>
          </table>
    ...
    methods: {
          ...
          selectRoom(value){
            ...
            for (let i = 1; i <= value; i++) {
              ...
              let newdata = {dummyRoomId: i, adults: 1, extraBed: 0, children: 0, childAge: 0};
          ...
          async createBooking(){
            ...
            let create = await axios.post('booking', transformKeys.snakeCase(data));
          ...
          async searchBooking(){
            ...
            this.overlay = true;
            let searching = await axios.get(`booking/search/${this.roomGroupId}/${this.dateFrom}/ ${this.dateTo}/${this.totalRoom}`)
            .then(resp => {
              this.overlay = false;
          ...
          finishBooking(){
            ...
            this.createBooking()
              .then(resp => {
                ...
                this.$router.push({name:'booking-success', params: { bookingid: this.orderid }});
              })
              .catch(err => {
                this.overlay = false;
